...
- The desktop launcher opens the browser only after worker health and the HTML workspace marker are both ready. A LiteLLM or browser-helper failure leaves the local Harness control page available with a bounded, redacted diagnostic.
